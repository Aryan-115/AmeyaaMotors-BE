...
const createReview = async (req,res) => {
    ...
    try {
        ...
        return res.status(201).json({success:true, message:"Thanks for the Review",
            data: newReview,
        });
...
const updateReview = async (req,res) => {
    ...
    try {
        ...
        return res.status(200).json({success:true, data: review, message: "Review update"});
    } catch (error) {
        return res.status(500).json({ success: false, message: error.message});
    }
}
...
const getReviews = async (req,res) => {
    try {
        ...
        return res.status(200).json({ success: true, data: reviews, message:"Reviews found"});
    } catch (error) {
        return res.status(500).json({ success: false, message: error.message });
    }
}
